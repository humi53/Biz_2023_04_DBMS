...
-- DBA 권한 테이블 생성, 수정, 삭제 데이터의 CRUD, COMMIT, ROLLBACK 등의 명령을
--      수행할 수 있다.
...
-- 이미 데이터가 주가되었는데 Table 구조의 문제를 발견했다
-- Table 을 변경(수정)하기
...
INSERT INTO tbl_student(st_num, st_name, st_dept, st_grade, st_tel)
VALUES('230003', '이몽룡', '행정학과', 4, '010-333-3333');
...
SELECT st_num, st_name, st_dept, st_grade, st_tel FROM tbl_student;
...
-- 2. 조회된 데이터 중에서 변경하고 하는 데이터의 PK가 무엇인지 확인한다
...
-- 원하지 ㅇ낳는 데이터가 삭제되는 현상을 '삭제 이상' 이라고 한다
