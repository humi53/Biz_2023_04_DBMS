...
DBMS 엔진에 따라서 insert 를 할때 자동으로 일련번호를 생성하는 기능이 있는데
오라클에는 없다(11 이하버젼), 오라클도 12이상에서는 자동생성하는 기능이 있는데
...
select * from tbl_acc WHERE acnum = '2023052301';

UPDATE tbl_acc
SET acbalance = 0
WHERE acnum = '';

SELECT aioseq, acnum, aiodate, aiotime, aiodiv, aioinput, aiooutput, aiorem FROM tbl_acclist
